...
<head>
	...
	<link type="text/css" href="/fair/ipad/grid/css/reportc5.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/reportc5control.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<!--纵轴-->
		...
		<div class="formula">
			...
			<div class="content">
				...
				<!--提交按钮-->
				<div class="submit">
					<button onclick="window.location.replace('/fair/ipad/grid/rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="rc5._saveRptSpecialColumnDef()">保存</button>
				</div>
			</div>
		</div>
	</div>
