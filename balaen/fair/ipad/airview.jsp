...
<html>
	<head>
	    ...
	    <link  rel="stylesheet" href="/fair/ipad/css/common/airview.css?t=<%=date %>" type="text/css" media="screen" title="no title" >
		...
		<script src="/fair/ipad/js/airviewcontrol.js?t=<%=date %>" charset="utf-8"></script> 
	...
	<div id="page" >
		...
		<div></div>
			...
			<div class='visible-xs filter_sel' >
				<img alt="filter_select" width="24px" height="24px" src="/fair/ipad/img/stock_standard-filter.png" onclick="airviewc.show_select_xs();">
			</div>
		</div>
					 ...
					 <div class="form-group col-sm-3" id="select_user">
					 	<div class="general_select_u">
							...
							<div class="input-group" id="select_user_div">
								...
								<select onchange="airviewc.select_user();" class="form-control selectpicker_user" >
								</select>
							</div>
						</div>
					</div>
