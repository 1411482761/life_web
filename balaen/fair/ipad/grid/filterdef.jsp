...
<head>
	...
	<link type="text/css" href="/fair/ipad/grid/css/reportfilter.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/reportfiltercontrol.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<div class="configure">
	...
	<div class="submit">
			<button onclick="window.location.replace('/fair/ipad/grid/rptconfig.jsp?name=<%=tbname%>')">返回</button>
