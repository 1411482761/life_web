...
<head>
	...
	<link type="text/css" href="css/reportsort.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="js/reportsortcontrol.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<!--度量-->
	...
	<!--提交按钮-->
	<div class="submit">
		<button onclick="window.location.replace('rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="rsc._saveRptSortColumnDef()">保存</button>
	</div>
