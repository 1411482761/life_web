...
<head>
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no">
    ...
    <link rel="stylesheet" type="text/css" href="css/common/graphicalconfig.css">
    <script type="text/javascript" src="js/graphicalcfgcontrol.js"></script>
              ...
              <div class="panel-body">
                    <form class="form-inline">
                      ...
                      <input id="cptdesc" type = "text" class="form-control" readonly>
                            ...
                            <input id="minWidth" type="text" style="display:none"/>
                            <input id="maxWidth" type="text" style="display:none"/>
                            <input id='lwr' type='text' style='display:none'/>
<!--                              <label for="height" class="control-label">高度:</label>
   ...
   <input id="height" type="text" class="form-control" value="1" data-max="768" data-min="1" data-step="1">
   <div class="input-group-addon">
       ...
       <a href="javascript:;" class="spin-down" data-spin="down"><i class="icon-sort-down"></i></a>
                            ...
                            <div class="input-group spinner " data-trigger="spinner" id="spinner" style="width:16%">
   <input id="width" type="text" class="form-control" value="1" data-max="1024" data-min="1" data-step="1">
   <div class="input-group-addon">
       <a href="javascript:;" class="spin-up" data-spin="up"><i class="icon-sort-up"></i></a>
       <a href="javascript:;" class="spin-down" data-spin="down"><i class="icon-sort-down"></i></a>
   </div>
...
<!--                             <div class="dropdown input-group" onclick="grc.fixbug()"  >
                  ...
                  <div class="pull-left">
                    ...
                    <button type="button" class="btn btn-primary" onclick="grc.reset()">重置</button>
                  </div>
         ...
         <div class="panel panel-success">
            ...
            <div class="panel-body ">
                ...
                <div class="pull-right"  >
                        ...
                        <button type="button" class="btn btn-primary" onclick="grc.saveAll('<%=rptname %>')">保存</button>
                </div>
            </div>
         </div>
       </div>
  ...
  <script type="text/javascript">
        jQuery(document).ready(function(){
          grc.loadCptList("<%=rptname%>","<%=cmd%>","<%=desc%>");
