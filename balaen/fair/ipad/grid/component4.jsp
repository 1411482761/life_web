...
<head>
	...
	<link type="text/css" href="/fair/ipad/grid/css/reportc4.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/reportc4control.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<!--纵轴-->
		...
		<div class="submit">
			<button onclick="window.location.replace('/fair/ipad/grid/rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="rc4._saveRptSpecialColumnDef()">保存</button>
		</div>
		<!--垃圾桶-->
		<div class="trash">
