...
<head>
	...
	<title>表配置页面</title>
	<link type="text/css" href="/fair/ipad/grid/css/relate.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/relatecontrol.js?t=<%=date %>"></script>
</head>
<body>
