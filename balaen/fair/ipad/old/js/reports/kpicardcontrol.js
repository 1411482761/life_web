...
KpiCardControl.prototype = {
	...
	getActived : function(){
		...
		for ( var i = 0; i < data.index.length; i++) {
			...
			'</td><td class="categoriestable-weight">'+kpi.weight+'</td><td class="categoriestable-rate"><span class="lamp-'+kpi.lamp+'"></span><span class="categoriestable-actualrate">'+Number(kpi.rate).format("0.00")+'</span></td><td class="categoriestable-scores">'+kpi.scores+'</td></tr>';
			total += kpi.weight;
			sum += kpi.scores;
