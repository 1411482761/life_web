<%
	...
	*/
	...
	int startIndex=ConfigValues.OBJECT_TAB_STARTIDX;
	...
	String singleObjectPageURL=(
		com.agilecontrol.nea.util.Validator.isNotNull(table.getRowURL())? com.agilecontrol.nea.core.util.WebKeys.NDS_URI +  table.getRowURL() +"?":
		com.agilecontrol.nea.core.util.WebKeys.NDS_URI +"/object/object.jsp?table="+table.getId()
		)
