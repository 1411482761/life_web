...
<head>
	...
	<link type="text/css" href="css/reportc3.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="js/reportc3control.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<!--纵轴-->
		...
		<div class="formula">
			...
			<div class="content">
				...
				<!--提交按钮-->
				<div class="submit">
					<button onclick="window.location.replace('rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="rc3._saveRptSpecialColumnDef()">保存</button>
				</div>
			</div>
		</div>
	</div>
