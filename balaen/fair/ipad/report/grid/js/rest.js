...
PortalClient.prototype = {
	...
	*/ 
	...
	/**
	Send one request and return one TransactionResponse, or raise error
	@param transaction should be ransaction object defined in API doc
	@param callback function, omit for synchronous call, function should have one argument for RestResponse object{code,message,data}
	*/ 
	sendOneRequest:function(transaction, callback){
		var req={};
		if(this._appKey!=null){
			var d = new Date();
			req.sip_appkey=this._appKey;
