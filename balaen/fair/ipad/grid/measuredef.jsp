...
<head>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/reportformatcontrol.js?t=<%=date %>"></script>
	<link type="text/css" href="/fair/ipad/grid/css/metric.css?t=<%=date %>" rel="StyleSheet"/>
</head>
<body>
	<!--度量定义-->
	...
	<!--提交按钮-->
	<div class="submit">
		<button onclick="window.location.replace('/fair/ipad/grid/rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="rfc._saveRptmeasureColumnDef()">保存</button>
	</div>
