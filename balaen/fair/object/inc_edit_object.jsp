...
<%
    ...
    <%		  }
     ...
     %>
		<span id="att_<%=columnDomId%>"  onaction="gc.showUploadDlg(<%=column.getId()%>,'<%=columnDomId%>')"><img border=0 width=16 height=16 align=absmiddle src='/nea/core/images/attach.gif' title='<%= PortletUtils.getMessage(pageContext, "open-new-page-to-config" ,null)%>'></span>            	
...
int checkProductAttribute= Tools.getInt(
	((Configurations)WebUtils.getServletContextManager().getActor(com.agilecontrol.nea.core.util.WebKeys.CONFIGURATIONS)).
