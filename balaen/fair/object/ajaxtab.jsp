...
if( mainTableObjectId==-1){
    mainTableObjectId=ParamUtils.getIntParameter(request,com.agilecontrol.nea.core.util.WebKeys.VALUE_HOLDER_PREFIX+"objectid", -1);
}
int status=0;
...
if(status==2) {
	isInput=false;
	request.setAttribute("com.agilecontrol.nea.core.request.object.mainobject.status", "2");
}	
/**
...
if (mainTableObjectId!=-1){
    ...
    Expression expr2=userWeb.getSecurityFilter(mainTable.getName(), com.agilecontrol.nea.core.security.Directory.READ);
...
%>
<%@ include file="/nea/core/object/object_tabcontent.jsp" %>
