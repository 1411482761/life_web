...
<head>
	...
	<title>表配置页面</title>
	<link type="text/css" href="/fair/ipad/grid/css/report.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/configurecontrol.js?t=<%=date %>"></script>
</head>
<body>
	<p class="topbutton">
	...
	<div class="left">
	 ...
	 <div class="configure" theme='<%=themeStyle%>'>
		...
		<div style="display:none;" class="filter">
			...
			<input type="checkbox" id="isacross_report"/>是否跨订货会报表
		</div>
		<div class="isview900">
		...
		<div class="isview900" style="margin-bottom:50px;">
			<span >url：</span><input id="pageurl"/>
		</div>
