...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
     ...
     <tr>
      ...
      <tr>
        <td colspan="2"><table width="420" border="0" cellspacing="0" cellpadding="0" class='bordertop' >
          <tr>
            <td width="100" class="tabselected"><div align="center"><a href="score.jsp?sessionkey=<%=sessionKey%>">KPI</a></div></td>
    ...
    <td rowspan="2" background="/fair/ipad/img/page_bg.gif">&nbsp;</td>
  </tr>

  <tr>
    <td colspan="3">
    	<img src="/fair/ipad/img/score.png" border="0">
    </td>
  </tr>
