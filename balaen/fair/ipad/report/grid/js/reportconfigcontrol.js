...
//			});
		...
		_drawrighthtml : function(result,paramDiv){
			...
			spanElem = "<span class='recreate config' onclick=window.location.replace('newtable.jsp?name="+reportconfigcontrol.tbname+"')>新建表</span>";
			jQuery(".target").append(spanElem);
...
//				reportconfigcontrol._draginit(".horizontal",paramDiv);
		...
		_setcolumns : function(){
			...
			if(selected.data("data").type=="col" || selected.data("data").type=="row"){
				window.location.replace('bindmeasure.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description+"&type="+selected.data("data").type);
			}else if(selected.data("data").type=="measure"){
				window.location.replace('measuredef.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description+"&dbname="+selected.data("data").dbname);
			}else if(selected.data("data").type.indexOf( 'component1')==0){
				window.location.replace('component1.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description);
			}else if(selected.data("data").type.indexOf( 'component2')==0){
				window.location.replace('component2.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description);
			}else if(selected.data("data").type.indexOf( 'component3')==0){
				window.location.replace('component3.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description);
			}else if(selected.data("data").type.indexOf( 'component4')==0){
				window.location.replace('component4.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description);
			}else if(selected.data("data").type.indexOf( 'component5')==0){
				window.location.replace('component5.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description);
			}else if(selected.data("data").type.indexOf( 'component6')==0){
				window.location.replace('component6.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description);
			}else if(selected.data("data").type.indexOf( 'component7')==0){
				window.location.replace('component7.jsp?id='+selected.data("data").id+"&tbname="+this.tbname+"&name="+selected.data("data").description);
			}else{
