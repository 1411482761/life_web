...
<head>
	...
	<link type="text/css" href="css/reportdetailed.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="js/reportspecialcontrol.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<!--纵轴-->
		...
		<div class="formula">
			...
			<div class="content">
				...
				<!--提交按钮-->
				<div class="submit">
					<button onclick="window.location.replace('rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="reportspecialcontrol._saveRptSpecialColumnDef()">保存</button>
				</div>
			</div>
		</div>
	</div>
