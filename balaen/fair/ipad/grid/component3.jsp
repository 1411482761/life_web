...
<head>
	...
	<link type="text/css" href="/fair/ipad/grid/css/reportc3.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/reportc3control.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<!--纵轴-->
		...
		<div class="formula">
			...
			<div class="content">
				...
				<div class="param-b">参数b：<span class="coln-b"></span></div>
				<div class="param-c">参数c：<span class="coln-c"></span></div>
				<div class="param-d">参数d：<span class="coln-d"></span></div>
				<div class="param-e">参数e：<span class="coln-e"></span></div>
				<div class="layout">格式显示：<select><option value="$0,0.00">$0,000.00</option><option value="￥0,0.00">￥0,000.00</option><option value="0,000">0,000</option><option value="0.00">0.00</option><option value="0.00%">0.00%</option></select></div> 
				<div class="define">算法定义：<input>(例如：a+b+c)</div>
				<!--提交按钮-->
				<div class="submit">
					<button onclick="window.location.replace('/fair/ipad/grid/rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="rc3._saveRptSpecialColumnDef()">保存</button>
				</div>
			</div>
		</div>
	</div>
