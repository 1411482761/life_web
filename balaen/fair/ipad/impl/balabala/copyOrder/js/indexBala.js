/**
 * Created by wang.pengfei on 2017/3/31 0031.
 */
'use strict';
angular.module('copyOrderBala', [
])
    .constant('$config', {
        'app': {
            /**
    ...
    .controller('MyCtrlBala', [
        ...
        function ($scope,$location,$miscCmd,$runSQL) {
             ...
             * 获取买手列表，若有定量，则不允许执行
             */
            var cmd = 'GetBalaBuyerData';//com.agilecontrol.fair.cmd.GetCopyBuyerData
            //显示第一页
            $miscCmd.execute(
                cmd, {
                    foid:foid,//bala需要根据foid找到订货会id从而找到下拉买手
