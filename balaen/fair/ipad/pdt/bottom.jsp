...
/**
	Nothing currently
 */
%><iframe id="print_iframe" name="print_iframe" width="1" height="1" src="/nea/core/common/null.html"></iframe>
<%
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
    ...
    <param name="movie" value="/nea/core/images/flash/playErrorSound.swf"/>
    <param name="flashvars" value="bridgeName=b_playErrorSound"/>
    <param name="quality" value="high" />
    <param name="allowScriptAccess" value="sameDomain"/>
    <embed src="/nea/core/images/flash/playErrorSound.swf" quality="high"
