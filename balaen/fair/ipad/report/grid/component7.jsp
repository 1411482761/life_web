...
<head>
	...
	<script type="text/javascript" src="js/reportc7control.js?t=<%=date %>"></script>
	<link type="text/css" href="css/reportc7.css?t=<%=date %>" rel="StyleSheet"/>
</head>
<body>
	<!--度量定义-->
	...
	<!--提交按钮-->
	<div class="submit">
		<button onclick="window.location.replace('rptconfig.jsp?name=<%=tbname%>')">返回</button><button onclick="rc7._saveRptmeasureColumnDef()">保存</button>
	</div>
