...
%>
    <td id="tdd_<%=column.getId()%>" width="<%=widthPerColumn%>%" nowrap align="left" valign='top' <%=(shouldDescTdDisplay?"class='desc'":"")%>>
	<%
    ...
    <td  id="tdv_<%=column.getId()%>" class="value" width="<%=widthPerColumn%>%" nowrap align="left" valign='top' <%=(ds.getColumns()-1)*2>0? "colspan='"+((ds.getColumns()-1)*2+1)+"'":"" %>>
      <%
