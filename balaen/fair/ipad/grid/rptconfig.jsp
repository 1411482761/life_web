...
<head>
	...
	<link type="text/css" href="/fair/ipad/grid/css/reportconfig.css?t=<%=date %>" rel="StyleSheet"/>
	...
	<script type="text/javascript" src="/fair/ipad/grid/js/reportconfigcontrol.js?t=<%=date %>"></script>
</head>
<body>
	<div class="container">
		<!--纵轴-->
	...
	<div class="submit">
		<button onclick="window.location.replace('/fair/ipad/grid/getrptviews.jsp')">返回</button>
		<button onclick="window.location.replace('/fair/ipad/grid/relate.jsp?tbname=<%=name%>')">关联关系</button>
		<button onclick="window.location.replace('/fair/ipad/grid/filterdef.jsp?tbname=<%=name%>')">过滤条件</button>
		<button onclick="window.location.replace('/fair/ipad/grid/sortdef.jsp?tbname=<%=name%>')">排序</button>
