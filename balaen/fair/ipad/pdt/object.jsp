...
<% 
	...
	boolean distinguish_app = ConfigValues.get("fair.whether_distinguish_app_version", true);
	Object tem=QueryEngine.getInstance().doQueryOne("select value from ad_param where name='fair.object.jsp'");
 	if(null!=tem&&!"".equals(tem.toString())){
 		request.getRequestDispatcher(tem.toString()).forward(request,response);
		 return;
 	}
%>
<%! 
...
<script type="text/javascript" src="/fair/ipad/js/objcontrols.js?t=<%=date%>"></script>
<link type="text/css" rel="stylesheet" href="/fair/ipad/css/common/object.css">
<script type="text/javascript">
jQuery(document).ready(function(){
	objcforandroid.load(<%=distinguish_app%>,'<%=themeStyle%>');
});
</script>
</head>
<body id="obj-body" style="display:none;">
